...
export const STAGE_ORDER: JobStage[] = ["queued", "capturing", "analyzing", "verifying", "indexing", "complete"];
...
export function stagePhase(stage: JobStage): "detection" | "analysis" | "ingestion" | "done" | "error" | "idle" {
