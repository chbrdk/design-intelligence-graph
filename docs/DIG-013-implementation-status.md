...
| DIG Next island + Plexon auth | In progress | `apps/web` AppShell + auth middleware; Coolify build TBD |
| Collection-scoped dig projects | Not started | |
| Coolify DIG staging | Not started | Proposed `dig.projects-a.plygrnd.tech` |
