...
export const paths = {
  ...
  libraryCopy: {
    ...
    uploadTitle: 'Graphic & campaign upload',
    uploadHint:
      'Choose the asset kind first (campaign, print, social, …). Graphics run a dedicated artboard pipeline with composition_contract — not the web capture / page_rhythm path. Only “Web screen” keeps the legacy still → desktop viewport ingest.',
    uploadKindLabel: 'Asset kind',
    ...
    screenInsightCraftMetricsRadarAria: 'score profile',
    screenInsightCraftMetricsRadarTop: 'Spider shows top {shown} of {total} scores',
    ...
    graphByStyle: 'Style',
    graphByLayout: 'Layout',
    graphByImagery: 'Imagery',
    graphByType: 'Type',
    graphByEnergy: 'Energy',
    graphByChrome: 'Chrome',
    graphByIndustry: 'Industry',
    graphSearch: 'Search',
    graphSearchPlaceholder: 'Domain, title, community…',
    graphLegend: 'Communities',
    graphInspector: 'Inspector',
    graphInspectorEmpty: 'Click a node to see community, degree, and top neighbors.',
    graphDegree: 'Degree',
  ...
  imageIngest: {
    imagesPath: '/images',
    fieldName: 'files',
    assetKindField: 'assetKind',
    defaultAssetKind: 'campaign_keyvisual',
    accept: 'image/jpeg,image/png,image/webp,image/gif',
    maxFiles: 40,
    uploadAssetKinds: [
      { value: 'campaign_keyvisual', label: 'Campaign / key visual' },
      { value: 'print_ad', label: 'Print ad' },
      { value: 'social_post', label: 'Social media post' },
      { value: 'brand_system', label: 'Brand system' },
      { value: 'moodboard', label: 'Moodboard' },
      { value: 'other_graphic', label: 'Other graphic' },
      { value: 'web_screen', label: 'Web screen (legacy still)' },
    ] as const,
  },
