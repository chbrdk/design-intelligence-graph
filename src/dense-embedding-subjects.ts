...
export async function buildDenseEmbeddingSubjects(
  ...
  const screenText = buildScreenEmbeddingCanonical({
    ...
    craft_tags: summary.craft_tags,
    imagery_density: summary.imagery_density,
    type_scale: summary.type_scale,
    type_image_mode: summary.type_image_mode,
    contrast_mode: summary.contrast_mode,
    composition_energy: summary.composition_energy,
    chrome_weight: summary.chrome_weight,
