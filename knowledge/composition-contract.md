...
3. JobRunner queues **graphic vision enrichment** (`applyGraphicLlmEnrichment` via EnrichmentQueue) — artboard `vision_page`, fine **graphic_craft_metrics** (~300 axes), and `llm-design.json`. No web section/`page_rhythm` stages.
