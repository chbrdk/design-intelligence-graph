#!/usr/bin/env python3
"""Build knowledge/catalogs/awwwards-plus-3000.json (fourth Awwwards wave)."""
...
OUT = ROOT / "knowledge" / "catalogs" / "awwwards-plus-3000.json"
SOURCE = ROOT / "knowledge" / "catalogs" / "sources" / "awwwards-websites-plus-3-2026.json"
EXISTING = [
...
def main() -> None:
    if not SOURCE.exists():
        raise SystemExit(f"missing {SOURCE}; run scripts/fetch-awwwards-plus-3000.py first")
    ...
    catalog = {
        "id": "awwwards-plus-3000",
        "title": "1000 additional Awwwards Visit-site homepages (wave 4, page 306+)",
        "source": "Fourth Awwwards wave from awwwards.com/websites page 306+. Excludes prior Awwwards catalogs and DIG catalogs.",
