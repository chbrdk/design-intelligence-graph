#!/usr/bin/env python3
"""Build knowledge/catalogs/awwwards-plus-2000.json (third Awwwards wave)."""
...
OUT = ROOT / "knowledge" / "catalogs" / "awwwards-plus-2000.json"
SOURCE = ROOT / "knowledge" / "catalogs" / "sources" / "awwwards-websites-plus-2-2026.json"
EXISTING = [
...
def main() -> None:
    if not SOURCE.exists():
        raise SystemExit(f"missing {SOURCE}; run scripts/fetch-awwwards-plus-2000.py first")
    ...
    catalog = {
        "id": "awwwards-plus-2000",
        "title": "1000 additional Awwwards Visit-site homepages (wave 3, page 235+)",
        "source": "Third Awwwards wave from awwwards.com/websites page 235+. Excludes awwwards-500, awwwards-plus-1000, and prior DIG catalogs.",
