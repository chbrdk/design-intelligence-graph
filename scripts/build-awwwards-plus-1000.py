#!/usr/bin/env python3
"""Build knowledge/catalogs/awwwards-plus-1000.json from resumed Awwwards scrape."""
...
OUT = ROOT / "knowledge" / "catalogs" / "awwwards-plus-1000.json"
SOURCE = ROOT / "knowledge" / "catalogs" / "sources" / "awwwards-websites-plus-2026.json"
EXISTING = [
...
def main() -> None:
    if not SOURCE.exists():
        raise SystemExit(f"missing {SOURCE}; run scripts/fetch-awwwards-plus.py first")
    ...
    catalog = {
        "id": "awwwards-plus-1000",
        "title": "1000 additional Awwwards Visit-site homepages (resume from page 22)",
        "source": "Second Awwwards wave: paginate awwwards.com/websites from page 22+, resolve Visit-site hrefs. Excludes awwwards-500 and all prior DIG catalogs.",
